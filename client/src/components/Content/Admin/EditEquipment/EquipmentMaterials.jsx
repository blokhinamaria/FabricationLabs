...
import { AddIcon, DeleteIcon } from "../../../Icons/Icons.jsx";
import AddNewMaterialDialog from "./Dialogs/AddNewMaterialDialog.jsx";
    ...
    return (
        <section className="flow">
            ...
            <AddNewMaterialDialog
                ref={dialogRef}
                dialogId="new-material-dialog"
                setIsDialogOpen={setIsDialogOpen}
                materials={materials}
                setMaterials={setMaterials}
                setMaterialUpdated={setMaterialUpdated}
            />
        </section>
    )
}
