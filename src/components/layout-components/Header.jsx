                ...
                <>
                    ...
                    <nav id='main-menu' className={isOpen ? 'open' : ''}>
                        <ul>
                            ...
                            {!user.role.includes('admin') && <li><button className='nav' disabled>Appointments</button></li>}
                            {!user.role.includes('admin') && <li><button className='nav' disabled>Profile</button></li>}
